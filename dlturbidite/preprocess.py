...
if __name__ == "__main__":
    dist_start = 0
    dist_end = 900
    original_data_dir = "/mnt/public/naruse/TC20181206/TC_training_data_G1"
    parent_dir = "/home/hajime/data/dlturbidite_data/20181206/G1"
    ...
    # del file_list[2]
    file_list = [original_data_dir + "/TCModel_for_ML_G1/output"]
    connect_dataset(dist_start, dist_end, file_list, outputdir,
                    offset=50, gclass_num=1, test_data_num=100)
